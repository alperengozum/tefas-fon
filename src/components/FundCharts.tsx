      ...
      <div className="h-72">
        <ResponsiveContainer>
          <AreaChart data={data}>
            ...
            <Area type="monotone" dataKey={metric} name={METRICS[metric][0]} stroke="var(--color-chart-1, #2563eb)" fill="var(--color-chart-1, #2563eb)" fillOpacity={0.15} dot={false} isAnimationActive={false} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
