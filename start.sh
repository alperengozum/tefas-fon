...
( while true; do nice -n 15 node scripts/ingest.mjs && nice -n 15 node scripts/holdings.mjs && nice -n 15 node scripts/kap-bulletin.mjs && sleep 86400 || sleep 3600; done ) &
